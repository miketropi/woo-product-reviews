...
function wpr_enqueue_scripts() {
  wp_enqueue_style('woo-product-reviews-css', WPR_URI . '/dist/css/woo-product-reviews.bundle.js', false, WPR_VERSION);
...
function wpr_admin_enqueue_scripts() {
  wp_enqueue_style('woo-product-reviews-css', WPR_URI . '/dist/css/woo-product-reviews.admin.bundle.js', false, WPR_VERSION);
